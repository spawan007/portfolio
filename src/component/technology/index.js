                ...
                <div className="slider-track">
                    {[...Array(2)].map((_, i) => (
                        <React.Fragment key={i + 1}>
                            ...
                            <Image key={i + "4"} src={'/techstack/gitlab.png'} width={100} height={60} alt="aws_image" />
                            <Image key={i + "5"} src={'/techstack/nextjs.png'} width={100} height={60} alt="aws_image" />
                            <Image key={i + "6"} src={'/techstack/react.png'} width={100} height={60} alt="aws_image" />
